...
public class Testi {
   public static void main (String [] args) {
    ...
    /*ohjelmoija ei toimi, sillä ei  ole rakenninta, jolla parametreja
    + ohjelmoija on oma luokkaansa, ei pääse käsiksi Ihminen-luokan asioita jos ei ole "super()" käytössä*/
